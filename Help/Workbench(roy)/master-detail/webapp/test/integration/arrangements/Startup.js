sap.ui.define([
	"sap/ui/test/Opa5",
	"sap/ui/splitapp/master-detail/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("sap.ui.splitapp.master-detail.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "sap.ui.splitapp.master-detail",
					async: true
				},
				hash: oOptions.hash,
